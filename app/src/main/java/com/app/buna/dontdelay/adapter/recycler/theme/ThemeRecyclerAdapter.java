package com.app.buna.dontdelay.adapter.recycler.theme;
...
public class ThemeRecyclerAdapter extends RecyclerView.Adapter<ThemeRecyclerAdapter.MyViewHolder>{
    ...
    ArrayList<com.app.buna.dontdelay.adapter.recycler.data.theme.ThemeData> mDataset;
    Context context;
    MainActivity mainActivity;
    SharedPreferences setting;
    SharedPreferences.Editor editor;

    public ThemeRecyclerAdapter(ArrayList<com.app.buna.dontdelay.adapter.recycler.data.theme.ThemeData> mDataset, Context context, MainActivity mainActivity){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        com.app.buna.dontdelay.adapter.recycler.data.theme.ThemeData data = mDataset.get(position);
        holder.themeImageView.setImageResource(data.getThemeImageResId());
        holder.themeTextView.setText(data.getThemeTitle());
        holder.themeItemView.setOnClickListener(view -> {
